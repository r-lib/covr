...
[![Azure pipelines test status](https://img.shields.io/azure-devops/tests/r-lib/covr/4?color=brightgreen&compact_message)](https://dev.azure.com/r-lib/covr/_build/latest?definitionId=2&branchName=master)
[![Azure pipelines coverage status](https://img.shields.io/azure-devops/coverage/r-lib/covr/4)](https://dev.azure.com/r-lib/covr/_build/latest?definitionId=4&branchName=master)
